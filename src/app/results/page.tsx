...
import { RisksRestrictionsSection } from "@/components/risks-restrictions-section"
    ...
    <div className="min-h-screen bg-white" style={{ backgroundColor: '#FFFFFF', position: 'relative' }}>
      ...
      <div className="w-full max-w-full box-border container mx-auto px-4 sm:px-6 py-6 sm:py-12 overflow-x-hidden">
        <div className="mx-auto w-full max-w-[1357px] min-w-0">
          ...
          <div className="rounded-lg px-4 sm:px-6 py-4 mb-6 sm:mb-8 w-full max-w-full min-w-0 lg:w-[calc(5*17.97%+4*1rem)] lg:ml-[3%] mt-6 sm:mt-8 pb-6 sm:pb-8" style={{ backgroundColor: '#CFDEE7', borderRadius: '0.5rem', display: 'flex', flexDirection: 'column' }}>
            <RisksRestrictionsSection
              planningConstraintsParam={searchParams.get("planningConstraints")}
              crimeSummaryParam={searchParams.get("crimeSummary")}
              broadbandCoverageParam={searchParams.get("broadbandCoverage")}
              environmentDataParam={searchParams.get("environmentData")}
            />
          </div>
